...
class PointMassEnv(MujocoEnv):
    ...
    def __init__(
        ...
        ** kwargs,
        ...
        # self.init_qpos = [0.0,0.0,0.0]
        # self.init_qvel = [0.0,0.0,0.0]


        self.target_state = [1.99963,1.49998,1.9996,0,0,0]

        print("target_state", self.target_state)
        # self.model.site_pos[self.model.site("target_state").id] = np.array([1.99963,1.49998,1.9996])
    ...
    def _is_done(self, distance_to_target):
        ...
        return distance_to_target > 5 or distance_to_target < 0.1
